...
CASE   
     WHEN AVG(Cast(b.weather_state AS DECIMAL(10,2)))<=15 THEN 'Cold'
     WHEN  AVG(CAST(b.weather_state AS DECIMAL(10,2)))>=25 THEN 'Hot'
     ELSE 'Warm' END as weather_type
FROM Countries a LEFT JOIN Weather b ON a.country_id=b.country_id
